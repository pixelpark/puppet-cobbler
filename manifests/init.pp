...
class cobbler (
  ...
  Stdlib::Absolutepath $config_path = '/etc/cobbler',
  String $config_file = 'settings',
  String $config_modules = 'modules.conf',
  Hash $default_cobbler_config = {
